...
import dev.kodewana.movies.repository.ReviewRepository;
...
public class ReviewService {
    ...
    public Review createReview(String bodyContent, String imdbId) {
        Review review = reviewRepository.insert(new Review(bodyContent));
